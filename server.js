  ...
  const response = await fetch(API_CONFIG.openai.url, {
    ...
    body: JSON.stringify({
      ...
      messages: [
        { 
          role: "system", 
          content: isTest ? "You are a test assistant. Respond with 'OK'." : "You are an expert business content creator. Return only the requested content without explanations."
        },
